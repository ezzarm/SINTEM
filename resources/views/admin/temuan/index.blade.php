...
<div class="adm-body">
                        ...
                        <div class="action-group">
                            ...
                            <button type="button" class="action-btn action-btn-view" title="Lihat Detail"
                                onclick="openDetailPanel({{ json_encode([
                                    ...
                                    'photo'       => isset($photoMap[$item->id]) ? ($photoMap[$item->id]->file_path ? asset('storage/' . $photoMap[$item->id]->file_path) : $photoMap[$item->id]->file_data) : null,
                                ]) }})">
    ...
    <div class="cards-wrap">
        @forelse($items as $i => $item)
        @php $photo = isset($photoMap[$item->id]) ? ($photoMap[$item->id]->file_path ? asset('storage/' . $photoMap[$item->id]->file_path) : $photoMap[$item->id]->file_data) : null; @endphp
        <div class="item-card">
            @if($photo)
