...
<style>
    ...
    /* ══ EDIT / ADD SIDE PANEL ══ */
    .edit-panel { position:fixed;right:-540px;top:0;bottom:0;width:480px;max-width:100vw;background:#fff;box-shadow:-4px 0 32px rgba(0,0,0,0.12);z-index:300;display:flex;flex-direction:column;transition:right 0.3s cubic-bezier(0.22,1,0.36,1); }
