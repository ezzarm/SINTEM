        ...
        <table id="mainTable">
            ...
            <tbody id="tableBody">
                ...
                <tr data-type="{{ $item->type }}" data-title="{{ strtolower($item->item_name) }}">
                    ...
                    <td>
                        <button class="action-btn" title="Lihat detail" onclick="openDetail({{ json_encode($item) }}, {{ json_encode(isset($photoMap[$item->id]) ? asset('storage/'.$photoMap[$item->id]->file_path) : null) }})">
                        ...
                        <button class="action-btn edit" title="Edit" onclick="openEdit({{ json_encode($item) }}, {{ json_encode(isset($photoMap[$item->id]) ? asset('storage/'.$photoMap[$item->id]->file_path) : null) }})">
    ...
    <div class="mobile-list" id="mobileList">
        ...
        <div class="m-card" data-type="{{ $item->type }}" data-title="{{ strtolower($item->item_name) }}">
            ...
            <div class="m-card-actions">
                <button class="m-action-btn" onclick="openDetail({{ json_encode($item) }}, {{ json_encode(isset($photoMap[$item->id]) ? asset('storage/'.$photoMap[$item->id]->file_path) : null) }})">
                ...
                @if($item->status === 'pending')
                <button class="m-action-btn" onclick="openEdit({{ json_encode($item) }}, {{ json_encode(isset($photoMap[$item->id]) ? asset('storage/'.$photoMap[$item->id]->file_path) : null) }})">
