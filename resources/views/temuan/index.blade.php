...
<style>
    ...
    .pg-toolbar-left { display: flex; align-items: center; gap: 6px; flex-wrap: wrap; }
    ...
    .pg-location { display: flex; align-items: center; gap: 4px; margin-top: 6px; font-size: 12px; color: #9ca3af; flex-wrap: wrap; }
    ...
    /* ══════════════════════════════════════════════
       BREAKPOINTS
       ▸ Tablet  768–1023px : hide sidebar widget panel, full-width feed
       ▸ Mobile  < 768px   : reduce toolbar padding, full-width search
       ▸ XS      < 480px   : compact toolbar, stacked dropdowns
    ══════════════════════════════════════════════ */

    /* ── Tablet: hide right sidebar, full-width feed ── */
    @media (max-width: 1023px) {
        .pg-side             { display: none; }
        .pg-main             { padding: 14px 20px 28px; }
    ...
    @media (max-width: 767px) {
        .pg-toolbar          { flex-direction: column; align-items: flex-start; gap: 8px; }
        .pg-toolbar-left     { width: 100%; }
        .pg-search-wrap      { width: 100%; }
        .pg-search           { width: 100%; }
        .pg-toolbar-wrap     { padding: 10px 16px 10px; }
        .pg-main             { padding: 12px 16px 24px; }
    }
...
<div class="pg-wrap">
    ...
    {{-- ── Toolbar: sort, type filter, search ── --}}
            ...
            <div class="pg-toolbar">
                ...
                <div class="pg-search-wrap">
                    ...
                    <input type="text" name="search" class="pg-search"
                        placeholder="Telusuri laporan temuan atau kehilangan..."
                        value="{{ $search ?? '' }}"
        ...
        <div class="pg-main">
            ...
            <div class="pg-post">
                ...
                <div class="pg-post-body">
                    ...
                    @if($photo)
                    <div class="pg-image">
                        <img src="{{ $photo->file_data }}" alt="{{ $item->item_name }}" onerror="this.parentElement.style.display='none'">
                    </div>
                    @endif
                </div>
            </div>
...
<script>
    ...
    // ── Select a dropdown option and submit the filter form ──
