                ...
                <div class="pg-toolbar-left">
                    ...
                    <div class="pg-dd-custom" id="sortDropdown">
                        ...
                        <div class="pg-dd-menu" id="sortMenu">
                            <button type="button"
                                    class="pg-dd-option {{ ($sort ?? 'terbaru') === 'terbaru' ? 'selected' : '' }}"
        ...
        <div class="pg-main">
            ...
            <div class="pg-post">
                ...
                <div class="pg-post-body">
                    <div class="pg-meta">
                        <span class="pg-author">{{ $item->user->name ?? 'Anonim' }}</span>
                    ...
                    <div class="pg-content">{{ $item->description }}{{ !empty($item->found_at) ? "\nLokasi : " . $item->found_at : '' }}</div>
            ...
            <div class="pg-empty">
                <svg width="36" height="36" fill="none" stroke="#d1d5db" viewBox="0 0 24 24">
                    <circle cx="11" cy="11" r="8" stroke-width="1.4"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4" d="M21 21l-4.35-4.35"/>
                </svg>
        ...
        <aside class="pg-side">
            ...
            <div class="pg-widget">
                <div class="pg-widget-head">
                    <svg width="13" height="13" fill="none" stroke="#5b21b6" viewBox="0 0 24 24">
                    ...
                    <span class="pg-widget-count" style="background:#ede9fe; color:#5b21b6;">
                ...
                <div class="pg-widget-list">
                    ...
                    <a href="{{ route('kalender.index') }}" class="pg-side-card">
                        ...
                        <div class="pg-side-info">
                            ...
                            <div class="pg-side-meta">{{ \Carbon\Carbon::parse($event->event_date)->format('d M Y') }}</div>
                        </div>
                    </a>
                    @empty
...
<script>
    ...
    function selectSort(value, label) {
        ...
        document.querySelectorAll('#sortDropdown .pg-dd-option').forEach(opt => {
    ...
    // ── Topbar dropdown ──
    function toggleTopbarDD() {
        const menu = document.getElementById('topbarDDMenu');
    ...
    document.addEventListener('click', e => {
        ...
        if (sortDD && !sortDD.contains(e.target)) sortDD.classList.remove('open');

        const topbarDD = document.getElementById('topbarDropdown');
        if (topbarDD && !topbarDD.contains(e.target)) {
            document.getElementById('topbarDDMenu').classList.remove('open');
            document.getElementById('topbarChevron').style.transform = 'rotate(0deg)';
        }
    });
</script>
@endpush