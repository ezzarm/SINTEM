...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->integer('role_id')->unsigned()->comment('References roles.id to determine permissions');
            ...
            $table->foreign('role_id', 'fk_users_role')->references('id')->on('roles')->onUpdate('cascade');
        });
        ...
        // 4. sessions (FK ke users — user_id bigint unsigned, users.id adalah int)
